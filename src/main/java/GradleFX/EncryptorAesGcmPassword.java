...
public class EncryptorAesGcmPassword {
    ...
    private static String decrypt(String cText, String password) throws Exception {
        ...
        try {
            ...
            System.out.println("Decoding error/wrong key");
            SceneController.setWrongKeyLabel();
            //Thread.sleep(5000);
            //System.exit(0);
        }
        return "null";
    ...
    public static String getDecodedText(String filename) {
        String decryptedText = "";
        try {
            decryptedText = EncryptorAesGcmPassword.decrypt(ReadFile2.load(filename), SceneController.mainKey);
    ...
    public String myDecrypt(String text) throws Exception {
        text = decrypt(text, SceneController.mainKey);
        return text;
    }
